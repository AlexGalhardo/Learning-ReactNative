	...
	constructor(props) {
		...
		this.state = {
			...
			list:[
				{
					key:1,
					title:'Sardinha Frita',
					img:require('../assets/images/tipos/pe.png'),
					description:'Sardinha que só o Wilson \nsabe fazer :D',
					bg:'#e35339',
					products:[
				...
				},
				{
					...
					description:'Vai uma porção de carne \ne batata frita ae?',
					bg:'#a6bb24',
					products:[
				...
				},
				{
					...
					description:'Maria Mole, Copo Sujo, \nCaipirinha com 51, Rabo de Galo,\ntem de tudo.',
					bg:'#079ed4',
					products:[
				...
				},
				{
					...
					description:'Os melhores salgados da cidade!',
					bg:'#fcb81c',
					products:[
